...
namespace QrMgr
{
    public partial class checkCode : System.Web.UI.Page, IHttpHandler, IRequiresSessionState  // 要使用session必须实现该接口
    {
            ...
            if(!IsPostBack)
        {
                ...
                Context.Session["Code"] = validateNum; //将字符串保存到Session中，以便需要时进行验证
